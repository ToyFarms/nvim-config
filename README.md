...
Taken from [kickstart.nvim](https://github.com/nvim-lua/kickstart.nvim)
...
else, it is recommended to separate it into its own file to `lua/plugins/c_<plugin_name>.lua`<br>
